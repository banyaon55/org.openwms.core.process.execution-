 ...
 */
package org.openwms.core.process.execution.app;
...
/**
 * A DisableActivitiAutoConfigurations disables all Activiti Spring AutoConfigurations that are present on the classpath in case either
